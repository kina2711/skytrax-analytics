...
select
    ...
    airline_name, customer_name, country, review_body, "Type Of Traveller" as type_of_traveller, "Seat Type" as seat_type, "Route" as route, "Date Flown" as date_flown_str, "Aircraft" as aircraft_type,
